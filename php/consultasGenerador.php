				...
				else
				{
					...
					else
					{
							...
							{	
							   ...
							   $query="select * from operators where \"ID_Operator\" in ( select * from operators natural join services_by_operator where \"ID_service\" in (select \"ID_service\" from services_by_frequency_ranks where \"ID_frequency_ranks\"=".$idConsulta."));";	
							   
							   exec("echo $query >> test.txt");				   
