<?php
	...
	$staticAssignation = (string)$head->staticAssignation;
	...
	$considerSeparation = (string)$head->considerSeparation;
	if(!strcmp($considerSeparation, true)) $considerSeparation="Sí";
