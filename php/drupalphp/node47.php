...
if($user->uid==0)
{
	...
	echo "<p class='estiloTitulo'>Gestión de entradas XML</p>";
	echo '<p style="text-align:left";><a class="iframe" href="http://avispa.univalle.edu.co/site/gestionEspectro/php/help/entradas.php"><img border="0" src="files/HelpIcon.gif" width="50" height="50"><br/>Ayuda</a></p>';
...
<div id="formularioHTML">
	<form action="/site/?q=node/47" accept-charset="UTF-8" method="post" id="test" enctype="multipart/form-data">
		<div class="form-item" id="edit-file-upload-wrapper">
			<label for="edit-file-upload">Ingresar XML de entrada: </label>
...
<?php
	...
	{		
		if(is_file("/var/www/html/site/gestionEspectro/entradas/".$user->uid."/".$archivo))
		{
			echo "<tr>\n";
			echo "<td>$archivo</td>\n";
