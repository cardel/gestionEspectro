			...
			<div id="agregarRango" style="display: none;">
				<div id="formularioHTML">
					<form action="/site/gestionEspectro/php/insert" accept-charset="UTF-8" method="post" id="test" enctype="multipart/form-data">		
						...
						<div class="form-item">
							<label>Ingrese las frecuencias de los canales </label>
							<input type="text" size="64" name="multiplicador" value="1" class="form-text"/>
							<input type="text" size="64" name="frecuenciaBase" value="1" class="form-text"/>
							<input type="text" size="64" name="frecuenciaCorrimiento" value="1" class="form-text"/>
							<input type="text" size="64" name="multiplicadorCorrimiento" value="1" class="form-text"/>
							<div class="description">
								Ingrese la formula de canales n*(multiplicador canal)*(frecuencia base)+(frecuencia)*(multiplicador)*n;
							</div>			
						</div>
